...
namespace WebApi.Migrations
{
    ...
    [Migration("20190731134139_kh_mig2")]
    partial class kh_mig2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Models.Administrateur", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebApi.Models.Appareil", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("CodeAppareil");

                    b.Property<string>("ConditionUtilisation");

                    b.Property<DateTime>("DateAchat");

                    b.Property<DateTime>("DateFabrication");

                    b.Property<DateTime>("DerniereDateUtilisation");

                    b.Property<string>("FrequenceUtilisation");

                    b.Property<int>("HopitalID");

                    b.Property<string>("NatureMaladieTraitent");
            ...
            modelBuilder.Entity("WebApi.Models.Hopital", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("NomHopital");

                    b.Property<string>("PositionGeographique");

                    b.Property<string>("RefHopital");
            ...
            modelBuilder.Entity("WebApi.Models.Appareil", b =>
                {
                    b.HasOne("WebApi.Models.Hopital")
                        .WithMany("Appareils")
            ...
            modelBuilder.Entity("WebApi.Models.Hopital", b =>
                {
                    b.HasOne("WebApi.Models.Administrateur")
                        .WithMany("Hopitals")
